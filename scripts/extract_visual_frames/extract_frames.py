...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', dest='out_dir', type=str, default='/mnt/sda/shenhao/datasets/MUSIC-AVQA/avqa_frame_1fps')
    parser.add_argument('--video_path', dest='video_path', type=str, default='/mnt/sda/shenhao/datasets/MUSIC-AVQA/')
